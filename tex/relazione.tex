...
\begin{document}
  \maketitle
    ...
    ciascuno dotato di 2 contesti. Ci aspettiamo quindi uno speedup quasi
    lineare fino a 8 elementi di calcolo, in seguito un plateau delle
    performance e un calo dell'efficienza.
    ...
    possiede un processore AMD A8-3850 a 4 core con clock 800MHz.
